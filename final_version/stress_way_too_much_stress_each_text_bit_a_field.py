...
def calculate_score(X, y):
    ...
    return float(number_of_correct_predictions) / float(len(X))
...
def cross_validate_wisard(tuple_sizes, number_of_folds, training_sample, sample_targets):
    ...
    for tuple_size in tuple_sizes:
        ...
        for fold in range(number_of_folds):
            ...
            score = calculate_score(wann.classify(training_sample_chunks[fold]), target_chunks[fold])
            scores.append(score)
            print(tuple_size, "Score: " + str(score) + ".\n")
...
def write_file_lines(output_file_name, contents_dict, header=False):
    if header:
        ...
        file.write("algorithm;field_size;file_name;number_of_fields;number_of_observations;number_of_observations_smote;tuple_size;number_of_folds;avg_accuracy;list_accuracies\n"
                  )
        file.close()
    else:
        ...
        for tuple_size in evaluated_tuple_sizes:
            ...
            line_contents = [
                ...
                # average accuracy
                str(sum(contents_dict["scores_dict"][tuple_size])/contents_dict["number_of_folds"]) + ";",

                # individual accuracies
                str(contents_dict["scores_dict"][tuple_size]) + ";",
...
for field_size in field_size_order:
    ...
    for file_name in files_and_data[field_size]["file_names"]:
        ...
        X_resampled, y_resampled = SMOTE().fit_sample(
